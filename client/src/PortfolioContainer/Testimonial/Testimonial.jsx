...
import broBg from "../../../src/img/Testimonial/ps-Mgo.jpg";
import sisBg from "../../../src/img/Testimonial/Mrs-Mgo.jpg";
import kumahBg from "../../../src/img/Testimonial/sasi-Kumar.png";
            ...
            >
                ...
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      ...
                      I am pleased to provide a strong recommendation for
                  ...
                  <img src={sisBg} alt="no internet connection" />
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  ...
                  <div className="client-info">
                  <img src={kumahBg} alt="no internet connection" />
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      I strongly endorse Nonkululeko based on their exceptional
                  ...
                  <div className="client-info">
                  <img src={broBg} alt="no internet connection" />
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      I strongly endorse Nonkululeko for their outstanding
                      performance as a Quality Assurer during their internship
                  ...
                  <div className="client-info">
                    <img src={mphoBg} alt="no internet connection" />
                    <h5>Mpho Thomas</h5>
                    <p>QA Lead</p>
                  </div>
                </div>
